...
class TestZwrotyModule:
    ...
    def setup_class(cls):
        ...
        driver.find_element(By.XPATH, locators.zwroty_button).click()
    ...
    @pytest.mark.flow
    def test_add_zwrot(self, nr_dokumentu, komentarz, is_exist ):
        ...
        driver.find_element(By.XPATH, locators.dodaj_zwrot_button).click()
        ...
        driver.find_element(By.XPATH, "//div[contains(@class,'MuiInputAdornment-root MuiInputAdornment-positionEnd')]//button[1]").click()
        driver.find_element(By.XPATH, locators.day_button).click()
        if is_exist == True:
            driver.find_element(By.XPATH, locators.confirm_dodaj_zwrot_button).click()
            driver.find_element(By.XPATH, "//span[text()='Przedmioty']").click()
